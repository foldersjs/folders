...
/*
 * remove an directory .The directory may contain files and folders also 
 * In that case they too get deleted .
 * FIXME : should be used only for removing empty directory .
 * implement 'rm' for this purpose
 */
